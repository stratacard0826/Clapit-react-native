...
import { changeUsername, changeAuthType, changeTabIndex } from './actions';
  ...
  renderPanelBlockUnder() {
    ...
    switch (authType) {
      case 'signup':
        return (
          <P>
            <FormattedMessage {...messages.panelBlockTitle} /> <LinkChange href="javascript:;" onClick={() => { this.clearState(); this.props.onChangeAuthType('login'); }}><FormattedMessage {...messages.panelBlockLogIn} /></LinkChange>
          </P>
        );
      case 'login':
        return (
          <P>
            <FormattedMessage {...messages.panelBlockTitleNoAccount} /> <LinkChange href="javascript:;" onClick={() => { this.clearState(); this.props.onChangeAuthType('signup'); }}><FormattedMessage {...messages.panelBlockSignUp} /></LinkChange>
          </P>
        );
      default:
        return (
      ...
      <div>
        <ArticleContainer>
          ...
          <Panel>
            ...
            <UnderBlock>
              <PUnder>
                <FormattedMessage {...messages.panelBlockUnderTitle} />
              </PUnder>
              <MarketDiv>
  ...
  renderPanelBlock() {
    ...
    switch (authType) {
      case 'signup':
        return (
          <div>
            <H2><FormattedMessage {...messages.panelBlockLogoTitle} /></H2>
            <Span>
              <FacebookLogin
                appId={FB_APP_ID}
                // autoLoad
            ...
            <HorizontalDiv>
              <LineDiv />
              <TextDiv><FormattedMessage {...messages.formHorizontText} /></TextDiv>
              <LineDiv />
            </HorizontalDiv>
            <InputDiv>
              <Input
        ...
        return (
          <div>
            <div>
              ...
              <Span>
                <Button onClick={this.onButtonPress} ><FormattedMessage {...messages.formButtonLogin} /></Button>
              </Span>
              <HorizontalDiv>
                <LineDiv />
                <TextDiv><FormattedMessage {...messages.formHorizontText} /></TextDiv>
    ...
    return (
      <article>
...

        {
          // <CenteredSection>
          //  <H2>
          //    <FormattedMessage {...messages.centerTitle} />
          //  </H2>
          // </CenteredSection>
        }
...
const mapStateToProps = (state) => {
  ...
  const { clapitAccountData, home } = state;
  const { username, authType, slideIndex } = home;
  return { clapitAccountData, username, authType, tabIndex: slideIndex };
};
