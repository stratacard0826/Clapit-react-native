...
export function fetchContactsToFollow(contacts, currentUserId, callback) {
  return (dispatch) => {
    ...
    const contactss = contacts.slice(0, 100);
...
export function fetchContactsToInvite(contacts, currentUserId, callback) {
  return (dispatch) => {
    ...
    return doFetch(`accounts/${currentUserId}/contactsToInvite`, {
      ...
      if (data.error) {
        dispatch(fetchContactsToInviteError(currentUserId, data.error));
...
export function loadDeviceContacts(callback) { // eslint-disable-line no-unused-vars
  // return (dispatch) => {
...
function loadDeviceContactsSuccess(data) { // eslint-disable-line no-unused-vars
  return {
...
function loadDeviceContactsError(error) { // eslint-disable-line no-unused-vars
  return {
